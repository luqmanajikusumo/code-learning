...
public class Model implements Serializable{
	...
	public String[] getArrUName() {
		return arruname;
	}
	public void setArrUName(String[] arruname) {
		this.arruname=arruname;
	}
	public String[] getArrPassword() {
		return arrpassword;
	}
	public void setArrPassword(String[] arrpassword) {
